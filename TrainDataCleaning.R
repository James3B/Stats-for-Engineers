...
totacts <- files2DF("D:\\R\\R_data", "txt")
...
write.csv(totacts, "D:\\R\\R_Output\\CleanerFile" , row.names = F)
...
write.csv(totactsClean, "D:\\R\\R_Output\\totactsClean", row.names = F)
#************************************
#
...
write.csv(xdmgimpute, file ="D:\\R\\R_Output\\xdmgImpute.csv", row.names = F)
# Get summary
